...
FUNCTION get_TAC
  ...
  //abund(lyear+1,fage)=sum(column(n,fage)(lyear-lastNumYrRec+1,lyear) )/double(lastNumYrRec);    //use average recruitment
    //if not believe lyear recru est
...
REPORT_SECTION
  ...
  report<<abund(lyear+2)<<endl;  //estimated abundance at age at the beginning of the tac setting year
  ...
  report<<Total_ssb<<endl;  //estimated ssb at the begining of the TAC setting year
  /*
